        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="title_card"><i class="fa fa-book green"></i>Custom categories and fields <small><?php echo TITLE_APP ?></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                <div class='col-md-12'>
                                <?php echo TITLE_APP ?> offers the possibility to associate an infinite number of categories and custom fields to each calendar created
                                
                                <br><br>
                                    
                                    </div>
                                    <div class="col-md-12"><h4>Custom categories</h4></div>
                                    <div class='col-md-12'>
                                        When creating a <a class="linkDoc in" title="new calendar instance" href="<?php echo _DIR_BE?>/new-calendar.php">new calendar</a>, 
                                        you can specify a list of categories that you want to associate in the "Categories" field of the form.
                                        If one or more categories are removed from the list, their association for all affected events is also automatically removed.  
                                         
                                    </div>
                                    <div class="col-md-12"><h4>Custom fields</h4></div>
                                    <div class='col-md-12'>
                                        As for the categories, it is possible to specify in the "Fields" field of the form a list of custom fields that you want to associate with a calendar
